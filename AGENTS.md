...
| orchestrator-committee | Swarm committee for decision-making (experts + KISS soft-veto + judge) | openai/gpt-5.2-codex | primary | Decision support only |
...
| committee-judge | Committee judge (final synthesis) | openai/gpt-5.2-codex | subagent | hidden |
