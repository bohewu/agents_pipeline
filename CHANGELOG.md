...
- Allowed a new release tag at the same commit as a branch updated in the same push to share that branch's known remote Commit Guard boundary; other new refs retain the all-ancestry check.
