...
- Do not turn validation tooling into a deliverable unless the assigned requirement explicitly requires it. Never build candidate-zero validators, mutation matrices, validators for validators, or a new proof framework to validate this task.
