...
export function SettingsIcon(props: IconProps) {
  return (
    <SvgIcon {...props}>
      <path d="M10.33 4.32a1.75 1.75 0 0 1 3.34 0l.18.74a1.75 1.75 0 0 0 2.62 1.05l.64-.38a1.75 1.75 0 0 1 2.28.32l.28.28a1.75 1.75 0 0 1 .32 2.28l-.38.64a1.75 1.75 0 0 0 1.05 2.62l.74.18a1.75 1.75 0 0 1 0 3.34l-.74.18a1.75 1.75 0 0 0-1.05 2.62l.38.64a1.75 1.75 0 0 1-.32 2.28l-.28.28a1.75 1.75 0 0 1-2.28.32l-.64-.38a1.75 1.75 0 0 0-2.62 1.05l-.18.74a1.75 1.75 0 0 1-3.34 0l-.18-.74a1.75 1.75 0 0 0-2.62-1.05l-.64.38a1.75 1.75 0 0 1-2.28-.32l-.28-.28a1.75 1.75 0 0 1-.32-2.28l.38-.64a1.75 1.75 0 0 0-1.05-2.62l-.74-.18a1.75 1.75 0 0 1 0-3.34l.74-.18a1.75 1.75 0 0 0 1.05-2.62l-.38-.64a1.75 1.75 0 0 1 .32-2.28l.28-.28a1.75 1.75 0 0 1 2.28-.32l.64.38a1.75 1.75 0 0 0 2.62-1.05z" />
