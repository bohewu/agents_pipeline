...
For every child result shown to the user, emit the protocol-defined adjacent role/model/effort selection line and distinguish verified or effective values from requested, inherited, unknown, or unverified values.
