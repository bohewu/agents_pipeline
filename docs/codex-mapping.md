...
- If the target already contains files not previously generated by this script, generation fails by default.
- Use `--force` only when you intend to overwrite an existing Codex config directory.
