...
1. `modernize-source-assessment.md` — Current state analysis of project A
2. `modernize-target-design.md` — Architecture and structure of project B or the target branch
3. `modernize-migration-strategy.md` — How to build B while A runs
4. `modernize-migration-roadmap.md` — Timeline, phases, and milestones
5. `modernize-migration-risks.md` — Risk register and governance
...
## Next Steps
<Short operator guidance. Include exact, copyable command snippets in fenced `text` blocks.>
```
