...
| `./protocols/schemas/codex-child-trace.schema.json` | CodexChildTrace | local Codex trace verifier | Schema-1.3 ephemeral bounded observed child model/role/effort values, optional expected-value comparisons, and parent-at-spawn effort comparison; never persisted as a ReasoningObservation |
