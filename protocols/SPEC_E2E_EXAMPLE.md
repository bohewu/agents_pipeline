...
- `protocols/examples/spec-to-pipeline/dev-spec.json`
- `protocols/examples/spec-to-pipeline/dev-spec.md`
- `protocols/examples/spec-to-pipeline/plan-outline.json`
- `protocols/examples/spec-to-pipeline/task-list.json`
