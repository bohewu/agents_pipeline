...
Usage:
  scripts/bootstrap-install-claude.sh [--repo <owner/repo>] [--version <tag|latest>] [--target <path>] [--no-backup] [--dry-run] [--keep-temp] [--verbose] [model profile options]
