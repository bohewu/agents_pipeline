...
Usage:
  scripts/bootstrap-install-copilot.sh [--repo <owner/repo>] [--version <tag|latest>] [--target <path>] [--no-backup] [--dry-run] [--keep-temp] [--verbose] [model profile options]
...
Options:
  ...
  --agent-profile <name|path>
                        Forward model profile selection to install-copilot.sh
  --model-set <name|path>
                        Forward runtime model-set selection to install-copilot.sh
  --profile-dir <path>  Forward agent profile directory override
  --model-set-dir <path>
                        Forward Copilot model-set directory override
  --uniform-model <model>
                        Forward uniform Copilot model selection
