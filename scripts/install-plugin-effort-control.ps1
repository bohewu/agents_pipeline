...
$sourceEntryFile = Join-Path $repoRoot "opencode/plugins/effort-control.js"
$sourceSupportDir = Join-Path $repoRoot "opencode/plugins/effort-control"
...
$relativeSpec = "./plugins/effort-control/index.js"
...
Write-Host "Install complete. OpenCode effort-control plugin is ready at: $targetPath"
