...
6. Obey its analysis-only boundary, expert selection, evidence, severity, artifact, and final-report constraints. Let effective Codex configuration select role models and reasoning.
