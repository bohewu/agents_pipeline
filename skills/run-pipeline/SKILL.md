...
Use the installed `orchestrator-pipeline` definition as the authoritative workflow. Keep model and reasoning selection in the effective Codex runtime/profile configuration.
...
4. Let the effective workspace/global Codex agent configuration select profile-specific role files and models. Do not rewrite model or reasoning settings from this skill.
