...
6. Obey its analysis-only boundary, evidence, specialist delegation, scoring, cleanup, and final-report constraints. Let effective Codex configuration select role models and reasoning.
